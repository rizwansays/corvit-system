...
class OurCoursesM extends Component {
  render(){
  ...
  return (
    <>
    <section style={{backgroundImage: `url(${bgCyber})`}} className='md:hidden relative bg-cyber w-full h-full py-14 bg-no-repeat bg-cover flex justify-center'>
          ...
          <div className=' mt-5 px-4'>
            ...
            {data.map((item, index) => (
              ...
              <div className='py-4 px-6 '>
                ...
                <p className='pb-3 text-sm '>{item.detail}</p>
                <hr />
