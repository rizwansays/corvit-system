   ...
   <>
    <div className='w-[100%] h-[100vh] '>
      <Carousele autoSlide={true} autoSlideInt={9000}>
        {[
        <video src={video2} autoPlay muted loop />, ...slide.map((s,i) => (
          <img className='w-[100%] object-cover' src={s.img} key={i} alt="" />
    ...
    <section style={{backgroundImage: `url(${bgCyber})`}} className='relative bg-cyber w-full h-full py-14 bg-no-repeat bg-cover flex justify-center'>
      <Container className='w-[100%]'>
        <Row>
          <div className='w-full mx-auto'>
            ...
            className='text-center text-3xl font-semibold text-red-600 '>Top IT Courses Near You</motion.h1>
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.3 }}
            className='border-b border-red-600 w-52 border-2 mx-auto'></motion.div>
            <motion.p
            variants={fadeIn("up", 0.4)}
            initial="hidden"
            whileInView={"show"}
            viewport={{ once: false, amount: 0.3 }}
            className='text-center text-white py-5 text-lg'>Learn in-demand skills with courses</motion.p>
          </div>
        </Row>
